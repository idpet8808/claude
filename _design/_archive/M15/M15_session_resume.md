...
> ⚠️ **아카이브 상태 (2026-05-07)** — M16 진입으로 본 인수인계는 `_design/_archive/M15/`로 이동. 본 인수인계의 "다음 세션 진행 항목"(Group B·C·D·E·F)은 *부분 진행 후 보류*. 현재 진행 인수인계는 `_design/M16_essence-redesign-brainstorming.md` 또는 후속 M16 plan 참조.
>
> ---
>
> 다음 세션 시작 시 **이 파일 1개만 읽으면 재개 가능** (M15 시점 기준 — 현재 M16 진입).
